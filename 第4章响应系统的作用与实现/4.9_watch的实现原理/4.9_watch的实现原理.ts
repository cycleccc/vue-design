...
const data: { [key: string | symbol]: string | boolean | number, foo: number, bar: number } = { foo: 1, bar: 2 }
// 代理对象
...
watch(() => obj.foo, (newValue: any, oldValue: any) => {
  console.log(`oldValue:${oldValue}
newValue:${newValue}`)
},    // 立即触发选项和异步执行选项    // {    //   flush: 'post'    // immediate: true    // })
